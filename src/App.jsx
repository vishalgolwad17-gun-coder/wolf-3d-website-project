  ...
  return (
    ...
    <main>
      <div className='images'>
        <img id = "Tomorrowland" src="/bgimages/image.png" alt="" />
        <img id = "Navy Pier" src="/bgimages/image copy.png" alt="" />
        <img id = "MSI Chicago" src="/bgimages/image copy 2.png" alt="" />
        <img id = "Lou" src="/bgimages/image copy 3.png" alt="" />
        <img id = "Kikk" src="/bgimages/image copy 4.png" alt="" />
      ...
      <section id='section1'>
        ...
        <div className='nav-element'><i className="ri-arrow-right-s-line"></i>My Showreel</div>
        <div className='nav-element'>
...
<p className='smalltext'>Our goal is to deliver amazing experiences that make <br />
...
<div className='links'>
  Facebook / Instagram / Dribbble / Twitter / Newsletter
      ...
      <section id='section2'>
        <small className='head'>Featured Projects</small>
        <div className='titles'>
          <div className='title' data-title="Tomorrowland">
            <small>2020 - ongoing</small>
            <h1>Tomorrowland</h1>
          </div>
        </div>
        <div className='titles'>
          <div className='title' data-title="Navy Pier">
            <small>2020 - ongoing</small>
            <h1>Navy Pier</h1>
          </div>
        </div>
        <div className='titles'>
          <div className='title' data-title="MSI Chicago">
            <small>2020 - ongoing</small>
            <h1>MSI Chicago</h1>
          </div>
        </div>
        <div className='titles'>
          <div className='title' data-title="This Was Louises Phone">
            <small>2020 - ongoing</small>
            <h1>This Was Louise's Phone</h1>
          </div>
        </div>
        <div className='titles'>
          <div className='title' data-title="KIKK Festival 2018">
            <small>2020 - ongoing</small>
            <h1>KIKK Festival 2018</h1>
          </div>
        </div>
        <div className='titles'>
          <div className='title' data-title="The Kennedy Center">
            <small>2020 - ongoing</small>
            <h1>The Kennedy Center</h1>
          </div>
        </div>
        <div className='titles'>
          <div className='title' data-title="Royal Opera Of Wallonia">
            <small>2020 - ongoing</small>
      ...
      <section id='section3'>
        <div className='left'>
          <p>We are a creative studio based in Liège, Belgium. We specialize in web design, branding, and digital experiences.</p>
        </div>
  
      </section>
      <section id='section4'>
        <div className='right'>
          <p className='rightleftp'>Dogstudio is a design & technology firm working globally from our offices based in Belgium and Chicago.
Our strong focus on producing high quality & emotional brandings, digital products and experiences became a signature.</p>

          <p className='rightrightp'>We’re passionate about moving people and solving problems for the likes of Microsoft, The Museum of Science And Industry Of Chicago, The Kennedy Center of Washington, Dragone, Quanta Magazine, and many more.</p>
        </div>
      </section>
    </main>
    </>
